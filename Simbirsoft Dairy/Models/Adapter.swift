...
// Преобразование типа JSON "task" (TaskModel) в тип CalendarKit "event" (EventModel) и наоборот

struct Adapter {
    
    // получение JSON [TaskModel] из CalendarKit [EventModel]
    ...
    // получение CalendarKit [EventModel] из JSON [TaskModel]
